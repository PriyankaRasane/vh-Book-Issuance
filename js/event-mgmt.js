(function($) {
     ...
     */
    function Student(id, name, board, location, grade, division , bookKitName, emailId, mobileNo,paymentStatus) {
        this.id = id;
        this.name = name;
        this.board = board;
     ...
     */
    function Filter(grade,board ,division, paymentStatus, handoverStatus) {
        this.grade = grade;
        this.board = board;
        this.division = division;
        this.paymentStatus = paymentStatus;
